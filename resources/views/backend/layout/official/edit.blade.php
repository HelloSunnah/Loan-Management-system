            ...
            <div class="card">
                <div class="card-body">
                    <div class="border p-3 rounded" style="margin-top: 20px;">
                        <center>
                            <h2>Accountant  Information Update</h2>
                        </center>
                        <form class="row g-3" method="post" id="studentData" action="{{ route('official.edit.post',$edit->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" placeholder="" name="birth_id" value="{{$edit->birth_id}}"  required>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="account_mantainer" value="{{$edit->account_mantainer}}"  id="">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Company Address<span style="color:red;"></span></label>
                                        <input type="text" class="form-control" name="company_address" value="{{$edit->company_address}}"  id="">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="trade_license"  value="{{$edit->trade_license}}"  id="">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">TIN<span style="color:red;"></span></label>
                                        <input type="text" class="form-control" name="tin" value="{{$edit->tin}}"  id="">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Issued By<span style="color:red;"></spissued_byan></label>
                                        <input type="text" class="form-control" name="issued_by" value="{{$edit->issued_by}}"  id="">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Issue Date<span style="color:red;"></span></label>
                                        <input type="date" class="form-control" name="issue_date" value="{{$edit->issue_date}}"  id="">
                                    </div>
                            ...
                            <div style="margin-top:30px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <label class="form-label">Name<span style="color:red;"></span></label>
                                        <input type="text" class="form-control" placeholder="" name="garanteer_name" value="{{$edit->garanteer_name}}"  required>
                                    </div>
                                    <div class="col-md-6">

                                        <label class="form-label">Name Bangla<span style="color:red;"></span></label>
                                        <input type="text" class="form-control" placeholder="" name="garanteer_name_bn" value="{{$edit->garanteer_name_bn}}"  required>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">NID <span style="color:red;"></span></label>
                                        <input type="number" class="form-control" name="garanteer_nid" value="{{$edit->garanteer_nid}}" >
                                    </div>


                                    <div class="col-md-6">
                                        <label class="form-label">Phone <span style="color:red;"></span></label>
                                        <input type="number" class="form-control" name="garanteer_phone" value="{{$edit->garanteer_phone}}" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="form-label">Image<span style="color:red;"></span></label>
                                        <input type="file" class="form-control" placeholder="" name="garanteer_image" value="{{$edit->garanteer_image}}"  >
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Signature <span style="color:red;"></span></label>
                                        <input type="file" class="form-control" name="garanteer_signature" value="{{$edit->garanteer_signature}}" >
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="nominee_nid"value="{{$edit->nominee_nid}}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Birth Id<span style="color:red;"></span></label>
                                        <input type="date" class="form-control" name="nominee_birth_id" value="{{$edit->nominee_birth_id}}" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
