                        ...
                        <form class="row g-3" method="post" action="{{ route('income.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="form-label"> Name<span style="color:red;">&nbsp;&nbsp;&nbsp;</span>
                                                <input type="text" name="income_by" class="form-control" name="form">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <label class="form-label"> Account Number (if any)<span style="color:red;">&nbsp;&nbsp;&nbsp;</span>
                                            <input type="text" name="account" class="form-control" name="form">
                                    </div>
                                </div>
                            </div>
