...
<script src="{{ asset("asset/plugins/croppie-2.6.2/croppie.min.js") }}"></script>
<script src="{{ asset("asset/plugins/facedetection.js") }}" type="text/javascript"></script>
<link rel="stylesheet" href="{{ asset("asset/plugins/croppie-2.6.2/croppie.min.css") }}">
<script>
